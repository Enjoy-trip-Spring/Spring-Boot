...
function searchAttraction() {
    let searchUrl = `http://localhost/attraction/listAjax?`;

    let sidoCode = document.getElementById("sido-code").value;
    let contentTypeId = document.getElementById("content-type-id").value;
...
function makeList(trips) {
    document.querySelector("#result").setAttribute("style", "display: ;");
...
//    let trips = data.response.body.items.item;
    ...
    trips.forEach((list) => {
        ...
        let markerInfo = {
            title: list.title,
            latlng: new kakao.maps.LatLng(list.latitude, list.longitude),
        };
        positions.push(markerInfo);
    });
    document.getElementById("item-list").innerHTML = tripList;
    displayMarker();
}
...
var mapCenter = new kakao.maps.LatLng(37.790132660, 127.52624250), // 지도의 중심좌표
    mapOption = {
